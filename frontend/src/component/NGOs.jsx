...
const NGOs = () => {
  ...
  useEffect(() => {
    const fetchNGOs = async () => {
      try {
        const response = await axios.get("http://127.0.0.1:8000/api/students/ngos/")
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-black text-white">
        ...
        >
          <strong className="font-bold">Error loading NGOs!</strong>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <motion.div className="text-center mb-12" initial="hidden" animate="visible" variants={titleVariants}>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Partner <span className="text-purple-500 glow-text animate-pulse-slow">NGOs</span>
          </h1>
          <motion.p
          ...
          >
            Organizations collaborating with our college for social impact
          </motion.p>
        </motion.div>
        ...
        {ngos.length === 0 ? (
          ...
          >
            <p className="text-gray-400">No NGOs found.</p>
          </motion.div>
        ) : (
          <motion.div
                  ...
                  <div className="h-64 overflow-hidden relative">
                    {ngo.image ? (
                      ...
                      <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        <span className="text-4xl text-purple-300">{ngo.name.charAt(0)}</span>
                      </motion.div>
                    )}
                  </div>
